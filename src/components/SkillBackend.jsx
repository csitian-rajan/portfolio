...
export const SkillBackend = () => {
    return (
        ...
        <div className="skill-card-front border-1 border-white/20 backdrop-blur bg-white/4 rounded-lg !p-5 !mt-5 hover:-translate-y-2 hover:border-sky-400 transition-all duration-300 h-60">
          <div className="skill-header info-item flex gap-3 !mt-5 text-white">
           <h1 className='text-3xl font-bold text-black bg-lime-400 rounded-lg !p-2 shadow-[0_0_20px_2px_rgba(163,230,53,0.75)]'> <FaServer /></h1>
          <h1 className='text-3xl font-bold text-lime-400 font-serif'>Backend</h1>
          </div>
